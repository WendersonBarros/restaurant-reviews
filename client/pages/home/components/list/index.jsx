          ...
          <div key={restaurant.id} className={styles.__listElementWrapper}>
            ...
            >
              <div className={styles.__details}>
                <div className={styles.__textContainer} title={restaurant.name}>
                  <IoRestaurant className={styles.__icon} /> {restaurant.name}
                </div>
                <div className={styles.__textContainer}>
                  <FaMapLocationDot className={styles.__icon} /> {restaurant.location}
                </div>
                <div>
            ...
            <button
              className={clicked === restaurant.id ? styles.__editButton : styles.__hiddenButton}
              onClick={() => onUpdate(restaurant.id)}
            >
              <FaEdit />
            </button>
            <button
              className={clicked === restaurant.id ? styles.__delButton : styles.__hiddenButton}
